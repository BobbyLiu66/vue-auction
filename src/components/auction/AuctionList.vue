<template>
  <div class="col-7 offset-md-1" v-if="auctions.length > 0">
        ...
        <div class="col-7 offset-md-2">
          <ul class="list-group">
            <li class="auction text-primary">
              <router-link :to="{name:'AuctionDetails',params:{id:auction.id}}"><h5>{{auction.title}}</h5></router-link>
            </li>
  ...
  <div class="col-9" v-else-if="auctions.length ===0">
